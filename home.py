...
# --- Page config ---
st.set_page_config(page_title="WYCO 2025 Season Standings as of 8/16/2025", layout="centered")
st.title("WYCO 2025 Season Standings as of 8/16/2025")
...
# --- Query top match-level score per shooter per venue ---
query_scores = """
SELECT
    sc.shooter_id,
    m.venue_id,
